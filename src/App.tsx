...
import { Box, Grid, Flex, Badge } from "@chakra-ui/react"
            ...
            <div className="Header-row1">
              ...
              <div className="range-buttons">
                ...
                <button
                  ...
                  style={{
                    fontWeight: `${range.day1 === "block" ? 700 : 400}`,
                  }}
                >
                  1D
                </button>
                <button
                  ...
                  style={{
                    fontWeight: `${range.day90 === "block" ? 700 : 400}`,
                  }}
                >
                  3M
                </button>
              ...
              <div className="group-buttons">
                ...
                <a href={`#${stocks[0]?.groupTitle}`}>
                  <div className="group-button">
                    {stocks[0]?.groupTitle.slice(0, 2)}
                  </div>
                </a>
                <a href={`#${stocks[1]?.groupTitle}`}>
                  <div className="group-button">
                    {stocks[1]?.groupTitle.slice(0, 2)}
                  </div>
                </a>
                <a href={`#${stocks[2]?.groupTitle}`}>
                  <div className="group-button">
                    {stocks[2]?.groupTitle.slice(0, 2)}
                  </div>
                </a>
                <a href={`#${stocks[3]?.groupTitle}`}>
                  <div className="group-button">
                    {stocks[3]?.groupTitle.slice(0, 2)}
                  </div>
                </a>
                <a href={`#${stocks[4]?.groupTitle}`}>
                  <div className="group-button">
                    {stocks[4]?.groupTitle.slice(0, 2)}
                  </div>
                </a>
                <a href={`#${stocks[5]?.groupTitle}`}>
                  <div className="group-button">
                    {stocks[5]?.groupTitle.slice(0, 2)}
                  </div>
                </a>
              </div>
            </div>
